...
QT_MOC_LITERAL(5, 50, 17), // "genNewUserManager"
QT_MOC_LITERAL(6, 68, 15), // "NewUserManager*"
QT_MOC_LITERAL(7, 84, 6), // "parent"
QT_MOC_LITERAL(8, 91, 16), // "genSessionsModel"
QT_MOC_LITERAL(9, 108, 14), // "SessionsModel*"
QT_MOC_LITERAL(10, 123, 10) // "stackDepth"
...
static const uint qt_meta_data_Homeseed[] = {
 ...
 // slots: parameters
    ...
    0x80000000 | 6,
    0x80000000 | 9, QMetaType::QObjectStar,    7,
    0x80000000 | 9,
...
void Homeseed::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { NewUserManager* _r = _t->genNewUserManager((*reinterpret_cast< QObject*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< NewUserManager**>(_a[0]) = _r; }  break;
        case 4: { NewUserManager* _r = _t->genNewUserManager();
            if (_a[0]) *reinterpret_cast< NewUserManager**>(_a[0]) = _r; }  break;
        case 5: { SessionsModel* _r = _t->genSessionsModel((*reinterpret_cast< QObject*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< SessionsModel**>(_a[0]) = _r; }  break;
        case 6: { SessionsModel* _r = _t->genSessionsModel();
            if (_a[0]) *reinterpret_cast< SessionsModel**>(_a[0]) = _r; }  break;
        default: ;
        }
